 ...
 * @projectName: skill
 * @package: org.feather.skill.config
 * @className: SentinelGatewayConfiguration
 * @author: feather
 * @description: Gateway 集成 Sentinel 实现限流
 * @since: 2024-04-21 15:30
 * @version: 1.0
 */
@Slf4j
@Configuration
...
//    @PostConstruct
    ...
    private void initGatewayRules() {
        ...
        rule.setResource("skill-nacos-client");
        // 按照 QPS 限流
    ...
    private void initBlockHandler() {
        ...
        BlockRequestHandler blockRequestHandler = new BlockRequestHandler() {
            ...
            public Mono<ServerResponse> handleRequest(ServerWebExchange serverWebExchange,
                ...
                result.put("route", "skill-nacos-client");
    ...
    private void initCustomizedApis() {
        ...
        ApiDefinition api = new ApiDefinition("nacos-client-api")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    // 模糊匹配 /feather/skill-nacos-client/ 及其子路径的所有请求
                    add(new ApiPathPredicateItem()
                            .setPattern("/feather/skill-nacos-client/**")
                            // 根据前缀匹配
        ...
        ApiDefinition api1 = new ApiDefinition("nacos-client-api-1")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    add(new ApiPathPredicateItem()
                            // 精确匹配 /feather/skill-nacos-client/nacos-client/service-instance
                            .setPattern("/feather/skill-nacos-client" +
        ...
        ApiDefinition api2 = new ApiDefinition("nacos-client-api-2")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    add(new ApiPathPredicateItem()
                            // 精确匹配 /feather/skill-nacos-client/nacos-client/project-config
                            .setPattern("/feather/skill-nacos-client" +

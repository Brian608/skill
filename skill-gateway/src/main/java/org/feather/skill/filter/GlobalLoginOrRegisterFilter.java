...
import org.feather.skill.constant.GatewayConstant;
...
public class GlobalLoginOrRegisterFilter implements GlobalFilter, Ordered {
     ...
     * @param uriFormat uriFormat
     * @return {@link String}
     * @author: feather
     * @since: 20-Jan-24 3:57 PM
     **/
   ...
   /**
    * description:  从 Post 请求中获取到请求数据
    * @param request  request
    * @return {@link String}
    * @author: feather
    * @since: 20-Jan-24 3:53 PM
    **/
